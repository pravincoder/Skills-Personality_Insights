...
def run():
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if 'Certifications' in resume_text:
                    resume_score = resume_score + 20
                    st.markdown(
                        '''<h4 style='text-align: left; color: #1ed760;'>[+] Awesome! You have added your Certifications🏅 </h4>''',
                        unsafe_allow_html=True)
                else:
                    st.markdown(
                        '''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add Certifications🏅. It will show that you are capable for the required position.</h4>''',
                        unsafe_allow_html=True)
                ...
                if st.button("Take Personality Test"):
                    # Open the browser to navigate to the Flask app
        ...
        if st.button('Login'):
            if ad_user == 'Heterize' and ad_password == 'heterize123':
                st.success("Welcome Ana")
                # Display Data
